...
class GRE:
        ...
        def __init__(self,U = ['u1','u2'],E = ['e1','e2','e3','e4'],T = ['t1','t2'],location = ['Stage 1', 'Stage 1', 'Stage 2', 'Room A'],sigma = [[0.8, 0.5],[0.5, 0.7]],mu_E = [[0.9, 0.3, 0, 0.6],[0.2, 0.6, 0.1, 0.6]],mu_C = [[0.8, 0.3],[0.4, 0.7]]):
                self.U = U
                self.S = []
                self.A = []
                self.E = E
